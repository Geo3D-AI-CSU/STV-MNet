...
#   修改train_percent用于改变验证集的比例 7:3
#   
#   当前该库将测试集当作验证集使用，不单独划分测试集
#-------------------------------------------------------#
trainval_percent    = 0.825##############这里为为使加入测量的74张图片的测试集与训练集比为2：8，调整后的比例
train_percent       = 0.7##################训练：验证为7：3
#-------------------------------------------------------#
#   指向VOC数据集所在的文件夹
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
VOCdevkit_path      = r'E:\Suyingcai\STV_MNet\code\STV_MNet\deeplab\deeplearning'
