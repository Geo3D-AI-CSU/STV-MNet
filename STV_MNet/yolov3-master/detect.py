...
def run(
        ...
        data=ROOT / 'data/Tree.yaml',  # dataset.yaml path
        imgsz=(1024, 2048),  # inference size (height, width)
    ...
    # Run inference and evaluate on test set
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/Tree.yaml', help='(optional) dataset.yaml path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[2048], help='inference size h,w')
    parser.add_argument('--conf-thres', type=float, default=0.25, help='confidence threshold')
    parser.add_argument('--iou-thres', type=float, default=0.12, help='NMS IoU threshold')
    ...
    parser.add_argument('--exist-ok', action='store_true', help='existing3 project/name ok, do not increment')
