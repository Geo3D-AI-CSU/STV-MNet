...
class Trainer(object):
    ...
    def training(self, epoch,loss_arr):
        train_loss = 0.0
        self.model.train()
    ...
    def validation(self, epoch,loss_arr):
        self.model.eval()
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='deeplearning',
                        choices=['pascal', 'coco', 'cityscapes', 'deeplearning'],
    ...
    for epoch in range(trainer.args.start_epoch, trainer.args.epochs):
        train_loss=trainer.training(epoch,train_loss)
        if not trainer.args.no_val and epoch % args.eval_interval == (args.eval_interval - 1):
            validation_loss=trainer.validation(epoch,validation_loss)
