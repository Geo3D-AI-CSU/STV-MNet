...
###########SE attention test################
from .attention.SEAttention import *
from .attention.CoTAttention import *
from .attention.GAMAttention import *
...
def torch_safe_load(weight):
    ...
    try:
        with temporary_modules(
            ...
            # ckpt = torch.load('runs/segment/split_3_dataset/weights/last.pt', map_location="cpu")
